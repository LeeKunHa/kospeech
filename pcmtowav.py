...
def filenum_padding_eval(filenum):
    """
    AI Hub 데이터셋에서 파일 번호는 '000001', '002545', '612543' 와 같은 형식으로 이루어져 있다.
    이러한 형식에 맞춰주기 위하여 파일 번호를 입력으로 받아 해당 포맷에 맞춰주는 함수를 미리 정의해둔다
    """
    if filenum < 10: 
        return 'E' + '0000' + str(filenum)
    elif filenum < 100: 
        return 'E' +'000' +  str(filenum)
    elif filenum < 1000: 
        return 'E' +'00' +  str(filenum)
    elif filenum < 10000: 
        return 'E' + '0' + str(filenum)
    elif filenum < 100000: 
        return 'E' + str(filenum)
    else: 
        return str(filenum)
...
scr_file_path = "C:\STT_data_test\KsponSpeech_eval\eval_other\KsponSpeech_"
dir_file_path = "C:\STT_data_test\KsponSpeech_eval\eval_other\KsponSpeech_"

for j in range(3001,6002): # 622546):
        num_1 = filenum_padding_eval(j)
